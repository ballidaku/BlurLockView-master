...
public class ShowActivity extends AppCompatActivity
    ...
    boolean showABC = false;


    public String TYPE = "FIRST_TIME";
...
*/
        ...
        /*blurLockView.setLeftButton("ABC");
    ...
    private void setHeading() {
        ...
        if(TYPE.equals("FIRST_TIME")) {
            blurLockView.setTitle("ENTER NEW MPIN");
        }
        else  if(TYPE.equals("CONFIRM_FIRST_TIME"))
        {
            blurLockView.setTitle("CONFIRM NEW MPIN");
        }
    }

    public void textNumberKeyboard() {
        showABC = !showABC;
        ...
        if (showABC) {
            ...
            blurLockView.setLeftButton("123");
            blurLockView.setType(Password.TEXT, false);
        }
    }
...
/*    private Password getPasswordType() {
    ...
    public void incorrect(String inputPassword) {
        ...
        else if (TYPE.equals("FIRST_TIME") && inputPassword.length()==4) {

            TYPE="CONFIRM_FIRST_TIME";
            setHeading();
    ...
    public void input(String inputPassword) {
        ...
        Log.e("inputPassword", "" + inputPassword);
