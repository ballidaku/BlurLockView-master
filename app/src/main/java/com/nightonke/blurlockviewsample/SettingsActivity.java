       ...
       /* showDuration = (SeekBar)findViewById(R.id.show_duration);
        ...
        go.setOnClickListener(new View.OnClickListener() {
           ...
           /*     if ("".equals(((EditText)findViewById(R.id.password)).getText().toString())) {
                ...
                Log.e("PASSWORD_TYPE", getPasswordType());
                Log.e("SHOW_DURATION",""+showDuration.getProgress() * 500);
                Log.e("HIDE_DURATION",""+hideDuration.getProgress() * 500);
                Log.e("SHOW_DIRECTION", ""+getShowDirection());
                Log.e("HIDE_DIRECTION", ""+getHideDirection());
                Log.e("SHOW_EASE_TYPE", ""+getShowEaseType());
                Log.e("HIDE_EASE_TYPE", ""+getHideEaseType());
                Log.e("TYPEFACE", getTypeface());*/
